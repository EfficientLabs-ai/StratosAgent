 ...
 *
 * WHY THIS MATTERS: when models are free, the value is no longer the inference — it is the
 ...
 *
 * BUILT ON STANDARD PRIMITIVES — NO NEW CRYPTO:
 *  - The append-only, tamper-evident HASH CHAIN is a standard construction
 ...
 *    INJECTED, so this stays pure and the same chain works across the
