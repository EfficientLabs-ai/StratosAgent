...
<img src="https://img.shields.io/badge/tests-17%20suites%20%C2%B7%20174%20hermetic-22c55e?style=for-the-badge" alt="Tests" />
...
> Run `npm test` — **17 hermetic suites (174 assertions), every one green**, no network and no LLM
> required. If any claim below breaks, a test goes red.
...
npm test           # 17 hermetic suites (174 assertions), all green
```
