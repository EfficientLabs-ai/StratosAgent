...
// NOTE: the upstream private build also runs an executor-wiring smoke check here, asserting that the
// signed-skill executor wires this gate behind an `enforceCapabilities` flag. That executor is part of
// the private (non-published) runtime, so the check is omitted from the public carve. The gate itself —
// the publicly verifiable least-privilege contract — is fully exercised above.
